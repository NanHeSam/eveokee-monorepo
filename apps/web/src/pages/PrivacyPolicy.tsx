      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <p className="text-gray-700 mt-2">We do not share diary content publicly without your consent.</p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 mb-2">If you are a California resident, you have rights under the California Consumer Privacy Act (CCPA), including:</p>
            <ul className="list-disc list-inside text-gray-700 space-y-2">
              <li>Request access to your personal information.</li>
              <li>Request deletion of your data.</li>
              <li>Opt-out of data sharing (we do not sell data).</li>
            </ul>
            <p className="text-gray-700 mt-2">To exercise these rights, contact <span className="font-mono">support@eveoky.com</span>.</p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700">If you have questions or requests regarding this Privacy Policy, contact us at:</p>
            <p className="text-gray-700">📧 <span className="font-mono">support@eveoky.com</span></p>
            <p className="text-gray-700">📍 San Jose, California, USA</p>
          </section>
        </div>
      </div>
    </div>
